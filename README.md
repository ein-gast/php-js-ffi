...
В проекте пять паок, назначение каждой из них:
...
Для сборки Go-прилоржения — контейнер `golang:1.24.3-bullseye`.
...
Для prod-сборки фронта команды не выведены наверх изнутри докера т.к. это демка.
